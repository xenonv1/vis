...
#
# // DEPRECATED: This file is deprecated.For the new product generation code, see productsGenerator.js
#
...
categories = ["Kühlschrank", "Waschmaschine",
              "Trockner", "Geschirrspüler", "Ofen", "Mikrowelle"]
...
def generate_description():
    descriptions = ["Hohe Energieeffizienz",
                    "Geräuscharm", "Einfache Bedienung", "Viel Platz"]
...
for i in range(1, 201):
    categoryRng = random.choice(categories)
    product = {
        "id": i,
        "name": categoryRng + " " + str(i),
